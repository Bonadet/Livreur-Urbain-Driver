...
//base url
String url =
    'https://www.livreururbain.com/'; //add '/' at the end of the url as 'https://url.com/'
...
rideRequest() {
  ...
  rideStart = FirebaseDatabase.instance
    ...
    if (event.snapshot.value != null) {
      ...
      // if()
      // matchingData.clear();
      // matchingData = rideList
      //     .where((element) => element['is_out_station'] == true)
      //     .toList();
    }
