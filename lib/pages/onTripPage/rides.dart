                              ...
                              child: Column(
                                children: [
                                  ...
                                  userDetails['active'] == true &&
                                      ...
                                      : (userDetails['active'] == true &&
                                              outSatationList.isNotEmpty &&
                                              driverReq.isEmpty &&
                                              rideType == 'outStation')
                                          ? Expanded(
                                              child: SingleChildScrollView(
                                                child: Column(
                                                  children: outSatationList
                                                      .asMap()
                                                      .map((key, value) {
                                                        // ignore: prefer_typing_uninitialized_variables
                                                        var dist0;
                                                        List stops = [];
                                                        if (outSatationList[key]
                                                                [
                                                                'trip_stops'] !=
                                                            'null') {
                                                          stops = jsonDecode(
                                                                ...
                                                                children: [
                                                                        ...
                                                                        child: InkWell(
                                                                            onTap: () {
                                                                              setState(() {
                                                                                choosenRide.clear();
                                                                                bidText.text = '';
                                                                                choosenRide.add(outSatationList[key]);
                                                                                _cancel = true;
                                                                              });
                                                                            },
                                                                            child: MyText(
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      (outSatationList[key]['return_time'] !=
                                                                              null)
                                                                          ? MyText(
                                                                              text: outSatationList[key]['return_time'],
                                                                              size: media.width * twelve,
                                                                              fontweight: FontWeight.w600,
                                                                              maxLines: 1,
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          decoration: BoxDecoration(
                                                                              ...
                                                                              image: DecorationImage(image: NetworkImage(outSatationList[key]['user_img']), fit: BoxFit.cover)),
                                                                        ),
                                                                        SizedBox(
                                                                          width:
                                                                              media.width * 0.05,
                                                                  ...
                                                                  SizedBox(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Expanded(
                                                                            child:
                                                                                MyText(text: outSatationList[key]['pick_address'], size: media.width * twelve)),
                                                                      ],
                                                                    ),
                                                                  ),
                                                                  SizedBox(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Row(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Expanded(child: MyText(text: outSatationList[key]['drop_address'], size: media.width * twelve)),
                                                                                ],
                                                                              ),
                                                                            ],
                                                                          )
                                                                    ...
                                                                    Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        SizedBox(
                                                                            ...
                                                                            child:
                                                                                MyText(
                                                                              text: outSatationList[key]['goods'],
                                                                              size: media.width * twelve,
                                                                              maxLines: 2,
                                                                            ))
                                                                      ],
                                                                  ...
                                                                  SizedBox(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        MyText(
                                                                          text:
                                                                              '${outSatationList[key]['currency']} ${outSatationList[key]['price']}',
                                                                          size: media.width *
                                                                              sixteen,
                                                                          fontweight:
                                                                              FontWeight.w600,
                                                                  ...
                                                                  if (outSatationList[
                                                                          ...
                                                                          'drivers'] !=
                                                                      null)
                                                                    // rideList[key].any((e) => e.toString().contains('driver_${userDetails['id'].toString()}'))
                                                                    //     ?
                                                                    if (outSatationList[key]['drivers']
                                                                            [
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          MyText(
                                                                              text: '${outSatationList[key]['currency']} ${outSatationList[key]['drivers']['driver_${userDetails['id']}']['price'].toString()}',
                                                                              size: media.width * sixteen,
                                                                              fontweight: FontWeight.w600),
                                                                        ],
                                                                      )
                                                                    ...
                                                                    onTap: () {
                                                                      if ((bidText.text.isEmpty &&
                                                                          ...
                                                                          (bidText.text.isNotEmpty &&
                                                                              int.parse(bidText.text.toString()) > 10)) {
                                                                        setState(
                                                                            () {
                                                                      ...
                                                                      if (bidText
                                                                        ...
                                                                        try {
                                                                          ...
                                                                          FirebaseDatabase
                                                                              ...
                                                                              .ref()
                                                                              .child(
                                                                                  'drivers/driver_${userDetails['id']}')
                                                                              .update({
                                                                            'is_available':
                                                                                false
                                                                          });
